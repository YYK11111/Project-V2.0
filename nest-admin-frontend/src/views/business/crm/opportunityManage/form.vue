...
<template>
  <div class="Gcard">
    <div class="mb20">
      <el-page-header @back="$router.back()" :title="isEdit ? '编辑销售机会' : '新增销售机会'" />
    </div>
    ...
    <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" style="max-width: 900px">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="机会名称" prop="name">
            <el-input v-model="form.name" placeholder="请输入机会名称" maxlength="100" show-word-limit />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="机会编号" prop="code">
            <el-input v-model="form.code" placeholder="请输入机会编号" maxlength="50" />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="成功概率(%)" prop="successRate">
            <el-slider v-model="form.successRate" :min="0" :max="100" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item>
        <el-button v-if="isEdit ? canOpportunityUpdate : canOpportunityAdd" type="primary" @click="submit">提交</el-button>
