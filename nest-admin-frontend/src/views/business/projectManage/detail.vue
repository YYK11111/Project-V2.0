    ...
    <el-tabs v-model="activeTab" class="mt20 project-tabs">
      <el-tab-pane label="概览" name="overview">
        <ProjectOverviewSummary
          ...
          :project-knowledge-summary="projectKnowledgeSummary"
          :execution-plan-summary="executionPlanSummary"
          ...
          :project="project"
          :execution-plan-progress="executionPlanProgress"
          :can-view-project-closure="canViewGroup('projectClosure')"
          @metric-card-click="handleMetricCardClick"
          @go-to-tab="goToTab"
          @project-alert-click="handleProjectAlertClick"
        />
