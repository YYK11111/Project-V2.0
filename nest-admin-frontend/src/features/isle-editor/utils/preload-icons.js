...
const icons = {
  ...
  image: {
    body: '<rect width="18" height="14" x="3" y="5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" rx="2"/><circle cx="9" cy="10" r="1.5" fill="currentColor"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 16l-5.5-5.5L7 19"/>',
    width: 24,
    height: 24,
  },
  video: {
    body: '<rect width="14" height="14" x="3" y="5" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" rx="2"/><path fill="currentColor" d="m11 10l4 2l-4 2z"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m17 10l4-2v8l-4-2"/>',
    width: 24,
    height: 24,
  },
  attachment: {
    body: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.5 6.5L9 14a3 3 0 1 0 4.24 4.24l7.07-7.07a5 5 0 1 0-7.07-7.07L5.4 12"/>',
    width: 24,
    height: 24,
  },
  upload: {
    body: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 16V4m0 0l-4 4m4-4l4 4M4 16v3a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-3"/>',
    width: 24,
    height: 24,
  },
  trash: {
    body: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18M8 6V4h8v2m-9 0l1 14h8l1-14"/>',
    width: 24,
    height: 24,
  },
  "refresh-cw": {
    body: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 1 1-2.64-6.36M21 3v6h-6"/>',
    width: 24,
    height: 24,
  },
  down: {
