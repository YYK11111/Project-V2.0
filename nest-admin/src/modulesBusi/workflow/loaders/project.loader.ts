...
export class ProjectLoader implements BusinessDataLoader {
  ...
  async load(businessKey: string): Promise<BusinessData> {
    ...
    const memberGroups = Object.values(ProjectMemberRole).reduce(
      (acc, role) => {
        acc[role] = normalizedMembers
  ...
  getFields(): FieldDefinition[] {
    return [
      ...
      {
        name: `memberGroups.${ProjectMemberRole.manager}`,
        label: "项目成员-项目经理",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.deliveryManager}`,
        label: "项目成员-交付经理",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.techLead}`,
        label: "项目成员-技术负责人",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.implementationLead}`,
        label: "项目成员-实施负责人",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.testLead}`,
        label: "项目成员-测试负责人",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.customerContact}`,
        label: "项目成员-客户联系人",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.businessContact}`,
        label: "项目成员-商务接口人",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.developer}`,
        label: "项目成员-开发工程师",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.implementationConsultant}`,
        label: "项目成员-实施顾问",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.tester}`,
        label: "项目成员-测试工程师",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.operationsEngineer}`,
        label: "项目成员-运维工程师",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.trainer}`,
        label: "项目成员-培训顾问",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.dataMigrationEngineer}`,
        label: "项目成员-数据迁移工程师",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.onsiteSupport}`,
        label: "项目成员-驻场支持",
        type: "array",
      },
      {
        name: `memberGroups.${ProjectMemberRole.member}`,
        label: "项目成员-普通成员",
        type: "array",
      },
