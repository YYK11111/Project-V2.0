...
import {
  ...
  WithdrawWorkflowDto,
  CancelWorkflowDto,
  CloseReturnedWorkflowDto,
  ResubmitReturnedWorkflowDto,
} from "./dto";
...
export class WorkflowController {
  ...
  async transferTask(
    ...
    return this.workflowService.transferTask(
      id,
      this.getCurrentUserId(req),
      dto,
    );
  ...
  async addSignTask(
    ...
    return this.workflowService.addSignTask(
      id,
      this.getCurrentUserId(req),
      dto,
    );
  ...
  async withdrawWorkflow(
    ...
    return this.workflowService.withdrawWorkflow(
      id,
      this.getCurrentUserId(req),
      dto,
    );
  ...
  async closeReturnedInstance(
    ...
    return this.workflowService.closeReturnedInstance(
      id,
      this.getCurrentUserId(req),
      dto,
    );
  ...
  async resubmitReturnedInstance(
    ...
    return this.workflowService.resubmitReturnedInstance(
      id,
      this.getCurrentUserId(req),
      dto,
    );
  ...
  async getHandledHistory(@Req() req, @Query() query) {
    return this.workflowService.getHandledHistory(
      this.getCurrentUserId(req),
      query,
    );
  }
  ...
  async getFieldMappings(
    ...
    if (scope === "all") {
      return this.businessFieldService.getAllFieldOptionsForBusinessType(
        businessType,
      );
    }
    return this.businessFieldService.getFieldMappingsForBusinessType(
      businessType,
    );
  }
  ...
  async generateFieldMappings(@Body() body: { businessTypes?: string[] }) {
    ...
    for (const businessType of businessTypes) {
      const count =
        await this.businessFieldService.generateAndSaveFieldMappings(
          businessType,
        );
  ...
  async updateFieldMapping(
    @Param("id") id: string,
    @Body()
    body: { fieldLabel?: string; description?: string; enabled?: boolean },
  ) {
