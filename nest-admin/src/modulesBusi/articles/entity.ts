...
export class Article extends BaseEntity {
  ...
  @BaseColumn({ type: "longtext", nullable: true, comment: "富文本内容" })
  content: string;
  ...
  @BaseColumn({ default: "0", comment: "是否置顶知识：1是 0否" })
  isTop: string;

  @BaseColumn({ type: "int", default: 0, comment: "置顶排序，越小越靠前" })
  topSort: number;
