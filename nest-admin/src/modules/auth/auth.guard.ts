...
export class AuthGuard implements CanActivate {
  ...
  private resolvePermissionByRequest(request: Request): string | undefined {
    ...
    const map: Array<[string, RegExp, string | ((req: Request) => string)]> = [
      ...
      ['GET', /^business\/articles\/getOne\/[^/]+$/, 'business/articles/getOne'],
      ['POST', /^business\/articles\/add$/, 'business/articles/add'],
      ['POST', /^business\/articles\/save$/, (req) => (req.body?.id ? 'business/articles/update' : 'business/articles/add')],
      ['PUT', /^business\/articles\/update$/, 'business/articles/update'],
      ['DELETE', /^business\/articles\/del\/[^/]+$/, 'business/articles/delete'],
      ['GET', /^business\/article-tags\/list$/, 'business/articleTags/list'],
      ['POST', /^business\/article-tags\/save$/, (req) => (req.body?.id ? 'business/articleTags/update' : 'business/articleTags/add')],
      ['DELETE', /^business\/article-tags\/del\/[^/]+$/, 'business/articleTags/delete'],
      ['POST', /^business\/article-borrows\/apply$/, 'business/articleBorrows/apply'],
      ['GET', /^business\/article-borrows\/my$/, 'business/articleBorrows/my'],
      ['GET', /^business\/article-borrows\/pending$/, 'business/articleBorrows/pending'],
      ['POST', /^business\/article-borrows\/[^/]+\/approve$/, 'business/articleBorrows/approve'],
      ['POST', /^business\/article-borrows\/[^/]+\/reject$/, 'business/articleBorrows/reject'],
      ['POST', /^business\/article-borrows\/[^/]+\/revoke$/, 'business/articleBorrows/revoke'],
